      ...
      >
        ...
        <form className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow">
          <input
            ...
            className="w-full p-3 mb-4 rounded bg-white dark:bg-gray-700"
          />
          <input
            type="email"
          ...
          <textarea
            ...
            className="w-full p-3 mb-4 rounded bg-white dark:bg-gray-700"
          ></textarea>
          <button className="w-full bg-indigo-600 text-white font-semibold py-3 rounded hover:bg-indigo-700 transition">
            Send Message
          </button>
        </form>
